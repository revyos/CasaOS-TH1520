#!/usr/bin/bash
#
#           CasaOS Installer Script v0.4.4-2#
...
readonly CASA_UNINSTALL_URL="https://get.casaos.io/uninstall/v0.4.4-2"
...
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-AppManagement/releases/download/v0.4.4-3-alpha2/linux-${TARGET_ARCH}-casaos-app-management-v0.4.4-3-alpha2.tar.gz"
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS/releases/download/v0.4.4-alpha7/linux-${TARGET_ARCH}-casaos-v0.4.4-alpha7.tar.gz"
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-CLI/releases/download/v0.4.4/linux-${TARGET_ARCH}-casaos-cli-v0.4.4.tar.gz"
"${CASA_DOWNLOAD_DOMAIN}IceWhaleTech/CasaOS-UI/releases/download/v0.4.4-4/linux-all-casaos-v0.4.4-4.tar.gz"
